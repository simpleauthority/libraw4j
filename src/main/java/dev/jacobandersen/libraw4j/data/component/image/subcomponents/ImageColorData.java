 ...
 */
public record ImageColorData(long[] toneCurve, long[] perChannelBlack, int black, int dataMaxPixelValue,
    ...
    public static ImageColorData load(MemorySegment librawData) {
        ...
        long[] toneCurve = libraw_colordata_t.curve$slice(data).toLongArray();
